...
import { databases, callAction, DB_ID, PROFILES_ID, Query } from '@/lib/appwrite'
...
async function approveUser(userId: string): Promise<void> {
  // Approval is enforced server-side (admin-team check); clients can't self-approve.
  await callAction('approveUser', { userId })
}
